local rt = utilities.RemoveOldObject(Texture(512, 512, e.FT_USAGE_RENDERTARGET))
...
event.AddListener("PostGameUpdate", "rt_test", function()
	render.EndFrame()
	render.RenderEnd()
